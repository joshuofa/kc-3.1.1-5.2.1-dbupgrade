...
VALUES (KRIM_ROLE_ID_BS_S.NEXTVAL, SYS_GUID(), 1, 'Requisitioner', 'KC-SUBAWARD', 'Subaward Requisitioner Role', (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NM = 'Derived Role: Requisitioner'), 'Y', SYSDATE)
/
