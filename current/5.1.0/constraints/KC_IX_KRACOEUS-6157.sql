...
/
-- This is already in the db as index name AWARD_DOCUMENTP1
-- DROP INDEX AWARD_DOCUMENTP1
-- /
...
/
-- This is already in the db as index name AWARD_CLOSEOUT_I2
DROP INDEX AWARD_CLOSEOUT_I2
/
create index IX_AWD_CLSOUT_AWARD_ID on AWARD_CLOSEOUT (AWARD_ID)
/
-- This is already in the db as index name AWARD_PERSONS_I2
DROP INDEX AWARD_PERSONS_I2
/
...
/
-- This is already in the db as index name AWARD_ATTACHMENT_I4
DROP INDEX AWARD_ATTACHMENT_I4
/
...
/
DROP INDEX AWARD_REPORT_TERMS_I7
/
...
/
DROP INDEX AWARD_SPECIAL_REVIEW_I2
/
...
/
DROP INDEX PROPOSAL_SPECIAL_REVIEW_I3
/
